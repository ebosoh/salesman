...
-- SEED INITIAL VISITS IN NAKURU COUNTY (WATER TANKS & PLUMBING PIPES)
INSERT INTO public.client_visits (
    ...
    (
        ...
        'Crown Hardware & Plumbing Supplies',
        '0722112201',
        'Kenyatta Avenue, Nakuru CBD',
        -0.2827,
        36.0673,
        'Requested quotation for 5x 5000L cylindrical plastic water tanks and 100 bundles of 1/2-inch and 3/4-inch PVC plumbing pipes.',
    ...
    (
        ...
        'Kaptembwa Plumbing & Tank Depot',
        '0733445502',
        'Kaptembwa Market, Nakuru West',
        -0.2980,
        36.0420,
        'Delivered sample water tanks (1000L - 10000L) & PVC plumbing pipes catalog. Owner requested follow-up next Tuesday.',
        'Tecno Spark 10 Pro',
    ...
    (
        ...
        'QuickFix Plumbing & Hardware Store',
        '0799887703',
        'Free Area Center, Nakuru East',
        -0.2805,
        36.1050,
        'Store visit recorded while in fast transit. Inquired about HDPE water pipes & 3000L plastic water tanks. Flagged anomaly.',
        'Infinix Hot 30',
    ...
    (
        ...
        'Mau View Hardware & Piping Mart',
        '0722334406',
        'Main Commercial St, Njoro Town',
        -0.3450,
        35.9400,
        'Ordered 50 bundles of Class B & C PVC plumbing pipes and 4x 2500L plastic water storage tanks.',
        'Redmi Note 12',
        NOW() - INTERVAL '1 hour',
        false,
        null
    ...
    (
        ...
        'Rift Valley Tanks & Piping Supplies',
        '0733556611',
        'Gilgil Town Center',
        -0.4931,
        36.2833,
        'Interested in Sewak 1000L & 2000L cylindrical plastic water tanks and PPR plumbing pipe fittings.',
        'Samsung Galaxy A24',
    ...
    (
        ...
        -0.7172,
        36.4310,
        'Verified delivery of PVC waste pipes, plumbing elbows, and 5000L vertical water tanks.',
        'Tecno Camon 20',
    ...
    (
        ...
        'Highland Tanks & Hardware Supplies',
        '0755778809',
        'Posta Road, Molo Town',
        -0.2480,
        35.7330,
        'Stock inquiry for Sewak UV-stabilized plastic water tanks (1000L, 5000L) and PVC plumbing conduit pipes.',
        'Infinix Note 30',
    ...
    (
        ...
        'Bahati Plumbing & Tank Hub',
        '0766889917',
        'Bahati Center, Nakuru North',
        -0.1550,
        36.1450,
        'Confirmed order for 8x 3000L plastic water tanks and 120 lengths of PPR hot & cold plumbing pipes.',
        'Samsung Galaxy A14',
